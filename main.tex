...
compiled to WebAssembly with a consistent ABI, 
...
It supports 32-but processing at a 480MHz clock rate
...
\begin{table}[ht]
\caption{Performance comparison of different runtimes.}
\centering
\begin{tabular}{|l|r|}
\hline
Runtime & Relative Performance \\
\hline
Native FAUST-exported C++ & 1.x (baseline) \\
WAMR AOT runtime & 0.970x \\
Wasm2c runtime & 0.852x \\
Wasmi runtime & 0.081x \\
\hline
\end{tabular}
