...
the LPA (Light-weight Plugin Architecture) plugin.
...
Some text about how f**king complicated these are to use.

Efforts have been made to provide alternative strategies 
to audio developers. 

One approach is that of domain-specific languages 
...
A downside is that the require programmers to learn
...
The fundamental philosophy of these languages, 
as well as their broader ecosystems, 
revolves around QUOTE SOMEONE ELSE[]. 
A downside of these DSL approaches is 
...
NOTE: VST SDK RELEASED OPEN SOURCE w/ MIT
